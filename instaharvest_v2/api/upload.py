...
class UploadAPI:
    ...
    def _upload_photo(self, image_data: bytes, upload_id: str = None) -> Dict[str, Any]:
        """
    ...
    def post_photo(
        ...
        upload_result = self._upload_photo(image_data, upload_id)
    ...
    def post_video(
        ...
        if thumbnail_data:
            self._upload_photo(thumbnail_data, upload_id)
    ...
    def post_story_photo(
        ...
        upload_id = self._generate_upload_id()
        self._upload_photo(image_data, upload_id)
    ...
    def post_story_video(
        ...
        upload_id = self._generate_upload_id()
        self._upload_video(video_data, upload_id, duration)
    ...
    def delete_media(self, media_id: int | str, media_type: int = 1) -> Dict[str, Any]:
        """
        Delete post.
