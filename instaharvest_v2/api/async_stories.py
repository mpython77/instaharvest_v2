...
class AsyncStoriesAPI:
    ...
    async def get_user_stories(self, user_id: int | str) -> Dict[str, Any]:
        """
    ...
    async def get_stories_parsed(self, user_id: int | str) -> Dict[str, Any]:
        """
        ...
        """
        raw = await self.get_user_stories(user_id)
        reel = raw.get("reel")
        ...
        for item in reel.get("items", []):
            story = await self._parse_story_item(item)
    ...
    async def _parse_story_item(self, item: Dict) -> Dict[str, Any]:
    ...
    async def get_tray_parsed(self) -> List[Dict[str, Any]]:
        """
    ...
    async def mark_seen(self, items: List[Dict]) -> Dict[str, Any]:
        """
    ...
    async def get_viewers(self, story_id: int | str) -> Dict[str, Any]:
        """
        Get story viewers.
    ...
    async def get_highlights_tray(self, user_id: int | str) -> Dict[str, Any]:
        """
    ...
    async def get_highlights_parsed(self, user_id: int | str) -> List[Dict[str, Any]]:
        """
        ...
        """
        raw = await self.get_highlights_tray(user_id)
        result = []
    ...
    async def get_highlight_items(self, highlight_id: str) -> Dict[str, Any]:
        """
    ...
    async def get_highlight_items_parsed(self, highlight_id: str) -> Dict[str, Any]:
        """
        ...
        """
        reel = await self.get_highlight_items(highlight_id)
        title = reel.get("title", "")
        items = []
        for item in reel.get("items", []):
            parsed = await self._parse_story_item(item)
            items.append(parsed)
    ...
    async def get_all_highlights_with_items(
        self,
        user_id: int | str,
        ...
        """
        highlights = await self.get_highlights_parsed(user_id)
        result = []
        for h in highlights:
            h_data = await self.get_highlight_items_parsed(h["id"])
            items = h_data["items"]
    ...
    async def delete_highlight(self, highlight_id: str) -> Dict[str, Any]:
        """
        Delete a highlight.
    ...
    async def scrape_user_complete(
        self,
        user_id: int | str,
        ...
        try:
            stories = await self.get_stories_parsed(user_id)
